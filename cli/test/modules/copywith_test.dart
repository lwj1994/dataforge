  ...
  group('CopyWith Functionality Tests', () {
    ...
    group('Deep Nested CopyWith', () {
      ...
      test('should support chained copyWith for Team (Level 3)', () {
        final updatedTeam = team1.copyWith.name('Backend Team');
      ...
      test('should support chained copyWith for Department (Level 2)', () {
        final updatedDepartment = department1.copyWith.name('Marketing');
      ...
      test('should support nested object updates', () {
        ...
        final newEmployee = employee1.copyWith.name('John Senior');
        final newTeam = team1.copyWith.leader(newEmployee);
        final newDepartment = department1.copyWith.teams([newTeam]);
        final newCompany = testCompany.copyWith.departments([newDepartment]);
