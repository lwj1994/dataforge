  ...
  group('Data Class Generator Tests', () {
    ...
    test('should generate code for existing models', () async {
      ...
      for (final modelFile in modelFiles) {
        ...
        print('✓ Generated code verified for $baseName (syntax and content)');
      }
    });
    ...
    test('should generate code with expected methods', () {
      final userFile = File('test/models/user.dart');
      if (userFile.existsSync()) {
        final generatedFile = File('test/models/user.data.dart');
        expect(generatedFile.existsSync(), isTrue);
        ...
        print('✓ All expected methods found in generated code');
      }
    });
    ...
    test('should handle JsonKey annotations correctly', () {
      final userFile = File('test/models/user.dart');
      if (userFile.existsSync()) {
        final userContent = userFile.readAsStringSync();
        final generatedFile = File('test/models/user.data.dart');

        if (userContent.contains('@JsonKey') && generatedFile.existsSync()) {
          final generatedContent = generatedFile.readAsStringSync();

          // If original file contains JsonKey annotations, generated code should handle field mapping correctly
          if (userContent.contains("name: 'user_name'")) {
            expect(generatedContent, contains("map['user_name']"),
                reason: 'Should use JsonKey name mapping');
          }

          print('✓ JsonKey annotations handled correctly');
        }
      }
    });
    ...
    test('should generate working factory fromJson methods', () {
      ...
      if (enumTypesFile.existsSync()) {
        ...
        print('✓ EnumTypes has factory fromJson method');
      }

      // Test Address (nested_objects.dart)
      final nestedObjectsFile = File('test/models/nested_objects.dart');
      if (nestedObjectsFile.existsSync()) {
        ...
        print('✓ All nested object classes have factory fromJson methods');
      }

      // Test DateTimeTypes
      final dateTimeTypesFile = File('test/models/datetime_types.dart');
      if (dateTimeTypesFile.existsSync()) {
        ...
        print('✓ All datetime classes have factory fromJson methods');
      }

      // Test CustomReadValue
      final customReadValueFile = File('test/models/custom_read_value.dart');
      if (customReadValueFile.existsSync()) {
        ...
        print('✓ CustomReadValue has factory fromJson method');
      }

      // Test MapTypes
      final mapTypesFile = File('test/models/map_types.dart');
      if (mapTypesFile.existsSync()) {
        ...
        print('✓ All map classes have factory fromJson methods');
      }

      print('🎉 All model classes have working factory fromJson methods!');
    });
    ...
    test('should use default values when fromJson receives empty map',
      ...
      print('✓ fromJson({}) correctly uses constructor default values');
    });
    ...
    test('should handle default values correctly in fromJson', () {
      ...
      final defaultValuesFile = File('test/models/default_values.dart');
      if (defaultValuesFile.existsSync()) {
        ...
        if (generatedFile.existsSync()) {
          ...
          print(
              '✓ fromJson({}) will correctly apply all constructor default values');
          print('✓ Default values functionality verified successfully');
        }
      }
    });
    ...
    test('should generate working toString method', () async {
      ...
      print('✓ DefaultValues toString: $defaultValuesToString');
      ...
      print('✓ NestedDefaultValues toString: $nestedToString');
      print('✓ toString method functionality verified successfully');
    });
  });
}
