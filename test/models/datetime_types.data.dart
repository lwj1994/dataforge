...
mixin _DateTimeTypes {
  ...
  static DateTimeTypes fromJson(Map<String, dynamic> map) {
    return DateTimeTypes(
      ...
      timestampDate: (DateTimeTypes._readValue(map, 'timestampDate') ?? DateTime.now()) as DateTime,
      ...
      customDuration: DateTimeTypes._readValue(map, 'customDuration') as Duration?,
    );
  }
}
