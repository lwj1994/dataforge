...
class _NestedDefaultValuesCopyWith {
  ...
  NestedDefaultValues Function(int?) get nested$IntValue {
    return (int? value) {
  ...
  NestedDefaultValues Function(String?) get nested$StringValue {
    return (String? value) {
  ...
  NestedDefaultValues Function(bool?) get nested$BoolValue {
    return (bool? value) {
  ...
  NestedDefaultValues Function(double?) get nested$DoubleValue {
    return (double? value) {
  ...
  NestedDefaultValues Function(List<String>?) get nested$ListValue {
